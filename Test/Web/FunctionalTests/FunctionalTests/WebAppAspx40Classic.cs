...
namespace Functional
{
    ...
    /// </summary>
    [TestClass]
    public class WebAppAspx40Classic : RequestTelemetryTestBase
    {
        private const string TestWebApplicaionSourcePath = @"..\TestApps\Aspx40\App";
        private const string TestWebApplicaionDestPath = "TestApps_Aspx40_App";
