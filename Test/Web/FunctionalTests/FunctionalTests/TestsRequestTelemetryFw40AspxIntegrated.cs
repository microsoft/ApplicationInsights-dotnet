// -----------------------------------------------------------------------
// <copyright file="TestsRequestTelemetryFw40AspxIntegrated.cs" company="Microsoft">
...
namespace Functional
{
    ...
    [TestClass]
    public class TestsRequestTelemetryFw40AspxIntegrated : RequestTelemetryTestBase
    {
        private const string TestWebApplicaionSourcePath = @"..\TestApps\Wa40Aspx\App";
        private const string TestWebApplicaionDestPath = "TestApps_TestsRequestTelemetryFw40AspxIntegrated_App";
