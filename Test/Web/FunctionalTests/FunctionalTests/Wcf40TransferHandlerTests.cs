namespace Functional
{
    ...
    /// </summary>
    [TestClass]
    public class Wcf40TransferHandlerTests : SingleWebHostTestBase
    {
        private const string TestWebApplicaionSourcePath = @"..\TestApps\Wcf40Tests\App";
        private const string TestWebApplicaionDestPath = "TestApps_Wcf40Tests_App";
