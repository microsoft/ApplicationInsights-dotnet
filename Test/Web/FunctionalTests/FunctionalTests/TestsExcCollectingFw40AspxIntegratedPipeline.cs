// -----------------------------------------------------------------------
// <copyright file="TestsExcCollectingFw40AspxIntegratedPipeline.cs" company="Microsoft">
...
namespace Functional
{
    ...
    [TestClass]
    public class TestsExcCollectingFw40AspxIntegratedPipeline : ExceptionTelemetryTestBase
    {
        private const string TestWebApplicaionSourcePath = @"..\TestApps\Wa40Aspx\App";
        private const string TestWebApplicaionDestPath = "TestApps_TestsExcCollectingFw40AspxIntegratedPipeline_App";
