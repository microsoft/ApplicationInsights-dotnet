// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TestsRequestTelemetryFw40AspxIntegratedWebSecurityOn.cs" company="Microsoft Corporation">
...
namespace Functional
{
    ...
    [TestClass]
    public class TestsRequestTelemetryFw40AspxIntegratedWebSecurityOn : SingleWebHostTestBase
    {
        private const string TestWebApplicaionSourcePath = @"..\TestApps\Wa40Aspx\App";
        private const string TestWebApplicaionDestPath = "TestApps_TestsRequestTelemetryFw40AspxIntegratedWebSecurityOn_App";
