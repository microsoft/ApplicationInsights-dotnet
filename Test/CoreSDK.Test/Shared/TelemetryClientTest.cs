namespace Microsoft.ApplicationInsights
{
    ...
    public class TelemetryClientTest
    {
        ...
        public void DefaultSamplingRateIs100Percent()
        {
            ...
            Assert.True(client.SamplingPercentage.EqualsWithPrecision(100.0, 1.0E-12));
        }

        [TestMethod]
        public void SamplingPercentageInheritedFromConfiguration()
        {
            var configuration = new TelemetryConfiguration() { SamplingPercentage = 50 };
            var client = new TelemetryClient(configuration);

            Assert.True(client.SamplingPercentage.EqualsWithPrecision(50, 1.0E-12));
        }

        [TestMethod]
        public void SamplingPercentageChangeInConfigurationReflectedInTelemetryClient()
        {
            var configuration = new TelemetryConfiguration() { SamplingPercentage = 50 };
            var client = new TelemetryClient(configuration);
            ...
            configuration.SamplingPercentage = 30;

            Assert.True(client.SamplingPercentage.EqualsWithPrecision(30, 1.0E-12));
        }

        [TestMethod]
        public void SamplingPercentageSetOnTelemetryClientOverridesValueInConfiguration()
        {
            var configuration = new TelemetryConfiguration() { SamplingPercentage = 50 };
            var client = new TelemetryClient(configuration) { SamplingPercentage = 10 };

            Assert.True(client.SamplingPercentage.EqualsWithPrecision(10, 1.0E-12));
        ...
        [TestMethod]
        public void SamplingPercentageSetOnActiveConfigurationReflectedOnTelemetryClient()
        {
            TelemetryConfiguration.Active.SamplingPercentage = 50;

            var client = new TelemetryClient();

            Assert.True(client.SamplingPercentage.EqualsWithPrecision(50, 1.0E-12));

            TelemetryConfiguration.Active.SamplingPercentage = 30;
        ...
        [TestMethod]
        public void TelemetryItemHasSamplingPercentageFromConfigurationIfNoneIsSpecifiedOnTelemetryClient()
        {
            var sentTelemetry = new List<ITelemetry>();
            var channel = new StubTelemetryChannel { OnSend = t => sentTelemetry.Add(t) };
            var configuration = new TelemetryConfiguration { InstrumentationKey = "Test key", SamplingPercentage = 50 };
            ...
            Assert.Equal(50, ((ISupportSampling)sentTelemetry[0]).SamplingPercentage);
        }

        [TestMethod]
        public void TelemetryItemHasSamplingPercentageFromTelemetryClientIfOneSpecified()
        {
            var sentTelemetry = new List<ITelemetry>();
            var channel = new StubTelemetryChannel { OnSend = t => sentTelemetry.Add(t) };
            var configuration = new TelemetryConfiguration { InstrumentationKey = "Test key", SamplingPercentage = 50 };

            var client = new TelemetryClient(configuration) { Channel = channel, SamplingPercentage = 20 };
        ...
        [TestMethod]
        public void SamplingIsOffInDeveloperMode()
        {
            var sentTelemetry = new List<ITelemetry>();
            var channel = new StubTelemetryChannel { OnSend = t => sentTelemetry.Add(t), DeveloperMode = true };
            var configuration = new TelemetryConfiguration { InstrumentationKey = "Test key" };
