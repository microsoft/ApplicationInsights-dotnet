...
namespace Microsoft.Extensions.Logging
{
    ...
    public static class ApplicationInsightsLoggingBuilderExtensions
    {
        ...
        /// <returns>Logging builder with Application Insights added to it.</returns>
        [Obsolete("InstrumentationKey based global ingestion is being deprecated. Use an AddApplicationInsights() overload to set TelemetryConfiguration.ConnectionString. See https://github.com/microsoft/ApplicationInsights-dotnet/issues/2560 for more details.")]
        ...
        /// <returns>Logging builder with Application Insights added to it.</returns>
        [Obsolete("InstrumentationKey based global ingestion is being deprecated. Use the AddApplicationInsights() overload to set TelemetryConfiguration.ConnectionString. See https://github.com/microsoft/ApplicationInsights-dotnet/issues/2560 for more details.")]
