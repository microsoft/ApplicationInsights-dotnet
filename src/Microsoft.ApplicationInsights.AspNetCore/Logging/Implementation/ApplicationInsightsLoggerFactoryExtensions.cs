...
namespace Microsoft.Extensions.Logging
{
    ...
    public static class ApplicationInsightsLoggerFactoryExtensions
    {
        ...
        /// </summary>
        public static ILoggerFactory AddAplicationInsights(this ILoggerFactory factory,
            TelemetryClient client)
        {
            return factory.AddAplicationInsights(client, LogLevel.Warning);
        }
        ...
        public static ILoggerFactory AddAplicationInsights(
            this ILoggerFactory factory,
            TelemetryClient client,
            LogLevel minLevel)
        {
            factory.AddAplicationInsights(client, (category, logLevel) => logLevel >= minLevel);
            return factory;
        }
