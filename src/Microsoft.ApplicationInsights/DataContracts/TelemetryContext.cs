...
#pragma warning disable CS0618 // Type or member is obsolete
            if (this.cloud != null)
            {
                this.cloud.RoleInstance = null;
                this.cloud.RoleName = null;
            }
            ...
            if (this.device != null)
            {
                ...
                this.device.OemName = null;

                // Deprecated and access properties
                // this.device.NetworkType = null;
                // this.device.Language = null;
                // this.device.ScreenResolution = null;

                this.device.OperatingSystem = null;
            ...
            // this.Context.InstrumentationKey = null;

            if (this.location != null)
            {
                this.location.Ip = null;
            }
            ...
            if (this.operation != null)
            {
                ...
                this.operation.SyntheticSource = null;
            }

            if (this.session != null)
            {
                this.session.Id = null;
                this.session.IsFirst = null;
            }

            if (this.user != null)
            {
                this.user.AccountId = null;
                this.user.AuthenticatedUserId = null;
                this.user.Id = null;
                this.user.UserAgent = null;
            }
#pragma warning restore CS0618 // Type or member is obsolete
        }
    }
