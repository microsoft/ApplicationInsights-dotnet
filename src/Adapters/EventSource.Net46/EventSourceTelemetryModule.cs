...
namespace Microsoft.ApplicationInsights.EventSourceListener
{
    ...
    public class EventSourceTelemetryModule : EventListener, ITelemetryModule
    {
        ...
        private List<EventSource> appDomainEventSources;
        private List<EventSource> enabledEventSources;

        /// <summary>
        /// EventSourceTelemetryModule default constructor.
        /// </summary>
        ...
        public void Initialize(TelemetryConfiguration configuration)
        {
            ...
            lock (this)
            {
                ...
                try
                {
                    ...
                    {
                        foreach (EventSource eventSource in this.appDomainEventSources)
                        {
        ...
        protected override void OnEventSourceCreated(EventSource eventSource)
        {
            ...
            lock (this)
            {
                if (this.appDomainEventSources == null)
                {
                    this.appDomainEventSources = new List<EventSource>();
                }

                this.appDomainEventSources.Add(eventSource);
