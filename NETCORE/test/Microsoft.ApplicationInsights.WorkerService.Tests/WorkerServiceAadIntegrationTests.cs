namespace Microsoft.ApplicationInsights.WorkerService.Tests
{
    ...
    /// <summary>
    /// Integration tests for Azure Active Directory (AAD) authentication support in WorkerService.
    /// </summary>
    public class WorkerServiceAadIntegrationTests
    {
        /// <summary>
        /// Tests that credential flows from ApplicationInsightsServiceOptions to AzureMonitorExporterOptions.
        /// </summary>
        [Fact]
        public void AddApplicationInsightsTelemetryWorkerService_WithCredential_FlowsCredentialToExporter()
        {
            // Arrange
