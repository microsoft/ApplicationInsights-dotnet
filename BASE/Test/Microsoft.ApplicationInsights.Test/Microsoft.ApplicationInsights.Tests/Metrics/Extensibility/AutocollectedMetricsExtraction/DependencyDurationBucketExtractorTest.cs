namespace Microsoft.ApplicationInsights.Extensibility.Implementation.Metrics
{
    ...
    [TestClass]
    public class DependencyDurationBucketExtractorTest
    {
        [TestMethod]
        public void DependencyDurationBucket()
        {
            var item = new DependencyTelemetry();            
            var extractor = new DependencyDurationBucketExtractor();
        ...
        [TestMethod]
        public void DependencyDurationEmptyBucket()
        {
            var item = new DependencyTelemetry();
            var extractor = new DependencyDurationBucketExtractor();
            var extractedDimension = extractor.ExtractDimension(item);
