namespace Microsoft.ApplicationInsights
{
    ...
    public sealed class TelemetryClient
    {
        ...
        internal TelemetryClient(TelemetryConfiguration configuration, bool isFromDependencyInjection)
        {
            ...
            // For non-DI scenarios: Register context and build SDK eagerly.
            ...
            {
                // Register this client's context for use by context processors in Build().
                // Thread-safe, first-write-wins: if another TelemetryClient already
                // registered a context, this is a no-op.
                configuration.RegisterProcessorContext(this.Context);
