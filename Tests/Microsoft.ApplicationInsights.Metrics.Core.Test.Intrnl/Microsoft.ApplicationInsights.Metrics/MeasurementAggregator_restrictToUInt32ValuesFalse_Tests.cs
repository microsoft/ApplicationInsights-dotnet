...
namespace Microsoft.ApplicationInsights.Metrics
{
    ...
    public class MeasurementAggregator_restrictToUInt32ValuesFalse_Tests
    {
        ...
        public void CreateAggregateUnsafe()
        {
            ...
            var seriesConfig = new MetricSeriesConfigurationForMeasurement(autoCleanupUnusedSeries: false, restrictToUInt32Values: false);
        ...
        public void CompleteAggregation()
        {
            ...
            var mesurementConfig = new MetricSeriesConfigurationForMeasurement(autoCleanupUnusedSeries: false, restrictToUInt32Values: false);
