    ...
    public class SimpleMetricConfigurationTests
    {
        ...
        public void Ctor()
        {
            ...
            { 
                var config = new SimpleMetricConfiguration(
                                    ...
                                    seriesConfig:               new MetricSeriesConfigurationForMeasurement(autoCleanupUnusedSeries: false, restrictToUInt32Values: true));
                Assert.IsNotNull(config);
        ...
        public void TestGetHashCode()
        {
            ...
            config2 = new SimpleMetricConfiguration(
                                seriesCountLimit: 1000,
                                valuesPerDimensionLimit: 100,
                                seriesConfig: new MetricSeriesConfigurationForMeasurement(autoCleanupUnusedSeries: true, restrictToUInt32Values: false));
