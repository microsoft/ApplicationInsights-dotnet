...
namespace Microsoft.ApplicationInsights
{
    ...
    public enum MetricAggregationScope
    {
        ...
        /// the <c>AdditionalDataContext</c>, the <c>InstrumentationKey</c> and other properties of the respective <c>TelemetryClient</c> will be ignored
        ...
        /// As a result, the <c>AdditionalDataContext</c> and the <c>InstrumentationKey</c> of the specified <c>telemetryClient</c> will be respected.
