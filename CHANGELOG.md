...
- [Enhancement: Simplify and speed-up access to TelemetryClient.GetMetricManager(..) by avoiding the ConditionalWeakTable.] (https://github.com/microsoft/ApplicationInsights-dotnet/issues/1196)
