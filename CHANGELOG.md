...
- [NEW: DependencyTelemetry contains an optional field to support tracking of dependency operation details] (https://github.com/Microsoft/ApplicationInsights-dotnet-server/issues/587)
