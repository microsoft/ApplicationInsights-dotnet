    ...
    public static class ApplicationInsightsExtensionsTests
    {
        ...
        public static class AddApplicationInsightsTelemetry
        {
            ...
            public static void RegistersExpectedServices(Type serviceType, Type implementationType, ServiceLifetime lifecycle)
            {
                ...
                services.AddApplicationInsightsTelemetry(new ConfigurationSection());
            ...
            {
                var services = ApplicationInsightsExtensionsTests.GetServiceCollectionWithContextAccessor();
                var config = new ConfigurationSection(Directory.GetCurrentDirectory()).AddJsonFile("content\\config-instrumentation-key.json");
            ...
            {
                var services = ApplicationInsightsExtensionsTests.GetServiceCollectionWithContextAccessor();
                var config = new ConfigurationSection(Directory.GetCurrentDirectory()).AddJsonFile("content\\config-developer-mode.json");
            ...
            {
                var services = ApplicationInsightsExtensionsTests.GetServiceCollectionWithContextAccessor();
                var config = new ConfigurationSection(Directory.GetCurrentDirectory()).AddJsonFile("content\\config-endpoint-address.json");
            ...
            public static void RegistersTelemetryConfigurationFactoryMethodThatReadsInstrumentationKeyFromEnvironment()
            {
                ...
                var config = new ConfigurationSection().AddEnvironmentVariables();
                try
                {
                    services.AddApplicationInsightsTelemetry(config);
        ...
        public static class AddApplicationInsightsSettings
        {
            ...
            public static void RegistersTelemetryConfigurationFactoryMethodThatReadsInstrumentationKeyFromSettings()
            {
                ...
                var config = new ConfigurationSection().AddApplicationInsightsSettings(instrumentationKey: "11111111-2222-3333-4444-555555555555");
                services.AddApplicationInsightsTelemetry(config);
            ...
            {
                var services = ApplicationInsightsExtensionsTests.GetServiceCollectionWithContextAccessor();
                var config = new ConfigurationSection().AddApplicationInsightsSettings(developerMode: true);
                services.AddApplicationInsightsTelemetry(config);
            ...
            {
                var services = ApplicationInsightsExtensionsTests.GetServiceCollectionWithContextAccessor();
                var config = new ConfigurationSection().AddApplicationInsightsSettings(endpointAddress: "http://localhost:1234/v2/track/");
                services.AddApplicationInsightsTelemetry(config);
