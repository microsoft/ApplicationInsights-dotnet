namespace Unit.Tests
{
    ...
    public class AccumulatedValuesTest
    {
        ...
        public void AccumulatedValuesAggregatesCorrectly()
        {
            ...
            // ACT
            Array.ForEach(accumulatedValues, accumulatorAverage.AddValue);
            Array.ForEach(accumulatedValues, accumulatorSum.AddValue);
            Array.ForEach(accumulatedValues, accumulatorMin.AddValue);
            Array.ForEach(accumulatedValues, accumulatorMax.AddValue);
